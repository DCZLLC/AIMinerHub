Contributing to AIMinerHub Core
============================

The AIMinerHub Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AIMinerHub Core project, and is not to be
confused with overall AIMinerHub Network Protocol consensus changes.

Whether a pull request is merged into AIMinerHub Core rests with the project merge
...
Patches that change AIMinerHub consensus rules are considerably more involved than
...
Where a patchset proposes to change the AIMinerHub consensus, it must have been
...
The project leader is the release manager for each AIMinerHub Core release.
