...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='aiminerhub.conf'
CONFIGFOLDER='/root/.aiminerhub'
COIN_DAEMON='aiminerhubd'
COIN_CLI='aiminerhub-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/decenomy/AIMH/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='aiminerhub'
COIN_PORT=13333
RPC_PORT=13334
