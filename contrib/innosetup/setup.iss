...
#define MyAppName "AIMinerHub Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://aiminerhub.com"
#define MyAppExeName "aiminerhub-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/AIMH/bootstrap.zip"
...
DefaultDirName={autopf}\AIMinerHub
...
OutputDir=.\output
OutputBaseFilename=AIMinerHubSetup
...
DefaultGroupName=AIMinerHub Core
...
[Files]
Source: ".\package\aiminerhub-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\AIMinerHub\AIMinerHub-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\AIMinerHub\AIMinerHub-Qt,strDataDir|{userappdata}\AIMinerHub\}');
  Result := True;
end;
