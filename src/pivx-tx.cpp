...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AIMinerHub aiminerhub-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  aiminerhub-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aiminerhub transaction") + "\n" +
                               "  aiminerhub-tx [options] -create [commands]   " + _("Create hex-encoded aiminerhub transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded aiminerhub transaction
