...
/* AIMinerHub GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AIMinerHub"
#define QAPP_ORG_DOMAIN "aiminerhub.org"
#define QAPP_APP_NAME_DEFAULT "AIMinerHub-Qt"
#define QAPP_APP_NAME_TESTNET "AIMinerHub-Qt-testnet"
