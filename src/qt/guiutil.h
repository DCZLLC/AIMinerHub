...
/** Utility functions used by the AIMinerHub Qt UI.
 */
namespace GUIUtil
{
...
// Render AIMH addresses in monospace font
...
// Parse "aiminerhub:" URI into recipient object, return true on successful parsing
