...
CAmount CRewards::GetBlockValue(int nHeight)
{
    ...
    else if (nHeight >      0) nSubsidy = 610000000 * COIN; //! Premine for sending coins to the coin holders. Final circulating supply is 607,146,002.03072373 AIMH so we will emit 610M.
    else                       nSubsidy = 0;
    // ---- Static reward table ----
