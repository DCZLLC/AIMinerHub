...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop AIMinerHub server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "AIMinerHub server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AIMH features */
        {"aiminerhub", "listmasternodes", &listmasternodes, true },
        {"aiminerhub", "getmasternodecount", &getmasternodecount, true },
        {"aiminerhub", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"aiminerhub", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"aiminerhub", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"aiminerhub", "masternodecurrent", &masternodecurrent, true },
        {"aiminerhub", "startmasternode", &startmasternode, true },
        {"aiminerhub", "reloadmasternodeconfig", &reloadmasternodeconfig, true },
        {"aiminerhub", "createmasternodekey", &createmasternodekey, true },
        {"aiminerhub", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"aiminerhub", "listmasternodeconf", &listmasternodeconf, true },
        {"aiminerhub", "getactivemasternodecount", &getactivemasternodecount, true },
        {"aiminerhub", "getmasternodestatus", &getmasternodestatus, true },
        {"aiminerhub", "getmasternodewinners", &getmasternodewinners, true },
        {"aiminerhub", "getmasternodescores", &getmasternodescores, true },
        {"aiminerhub", "mnsync", &mnsync, true },
        {"aiminerhub", "spork", &spork, true },
        {"aiminerhub", "mnping", &mnping, true },
...
{
    return "> aiminerhub-cli " + methodname + " " + args + "\n";
}
