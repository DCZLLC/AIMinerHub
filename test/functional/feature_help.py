...
"""Verify that starting aiminerhub with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aiminerhub with -? for help text")
        ...
        self.log.info("Start aiminerhub with -version for version information")
