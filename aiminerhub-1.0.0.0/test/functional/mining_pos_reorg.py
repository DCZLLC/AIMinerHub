...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected AIMH supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check AIMH supply at the beginning
        # ------------------------------------------
        # AIMH supply: block rewards minus burned fees for minting
        ...
        # Verify that AIMH supplies were properly updated after the spends and reorgs
        self.log.info("Check AIMH supply...")
